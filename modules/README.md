...
| [langchain_mlrun](https://github.com/mlrun/functions/tree/development/modules/src/langchain_mlrun) | LangChain x MLRun integration - Orchestrate your LangChain code with MLRun. | generic | langchain, langgraph, tracing, monitoring, llm |
| [oai_spo](https://github.com/mlrun/functions/tree/development/modules/src/oai_spo) | OAI SPO use case for industrial optimization | generic | model-serving, structured-ML |
