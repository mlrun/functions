...
class HistogramDataDriftApplication(ModelMonitoringApplicationBase):
    ...
    * Plotly table with the various metrics and histograms per feature.
    ...
    can either modify the downloaded source code file directly, or inherit from this class (in the same file), then
    deploy it as any other model monitoring application.
