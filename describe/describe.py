...
def summarize(
    ...
    try:
        ...
        context.logger.error(f'Failed to create violin distribution plots due to: {e}')
    ...
    if label_column: 
        ...
        try:
            ...
            context.logger.error(f'Failed to create class imbalance plot due to: {e}')
    ...
    try:
        ...
        extra_data["correlation"] = context.log_artifact(PlotArtifact("correlation",  body=plt.gcf(), title='Correlation Matrix'),
            ...
            context.logger.error(f'Failed to create features correlation plot due to: {e}')
